...
1. Download the latest release from the section [Releases](https://github.com/GhOsTiK56/Obsidian-Shelf/releases).
...
git clone https://github.com/GhOsTiK56/Obsidian-Shelf.git
